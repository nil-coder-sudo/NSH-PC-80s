...
/*----------------------------------------------------------------------------
 * ILI9341 LCD Driver Definitions (for 2.8" TFT Shield)
 *
 * NOTE: The ILI9341 driver requires these GPIOs to be defined.
 * These pins connect to the standard Arduino Due headers.
 *----------------------------------------------------------------------------*/

/* 1. Reset (RST) Pin: D8 (PC21) */
#define GPIO_ILI9341_RST  (GPIO_OUTPUT | GPIO_CFG_PULLUP | GPIO_PORT_PIOC | GPIO_PIN21)

/* 2. Data/Command (DC) Pin: D9 (PA27) */
#define GPIO_ILI9341_DC   (GPIO_OUTPUT | GPIO_CFG_PULLUP | GPIO_PORT_PIOA | GPIO_PIN27)

/* 3. Chip Select (CS) Pin: D10 (PA28) */
#define GPIO_ILI9341_CS   (GPIO_OUTPUT | GPIO_CFG_PULLUP | GPIO_PORT_PIOA | GPIO_PIN28)
